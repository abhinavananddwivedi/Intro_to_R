...
\begin{verbatim}
## [1] 0.05153562 0.19364533 0.14827783 0.88824812 0.09306298 0.25072868
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[df}\OperatorTok{$}\NormalTok{b }\OperatorTok{<}\StringTok{ }\FloatTok{0.5}\NormalTok{, ] }\CommentTok{#only those rows whose column b has values < 0.5}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##             a           b  c
## 1  0.05153562 -0.01182414 11
## 2  0.19364533 -0.01915757 12
## 4  0.88824812 -1.90512567 14
## 8  0.35732324 -0.72833851 18
## 9  0.67740427 -1.53053833 19
## 10 0.27754404 -1.83642660 20
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[df}\OperatorTok{$}\NormalTok{c }\OperatorTok{>=}\StringTok{ }\DecValTok{14}\NormalTok{, }\StringTok{"a"}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
...
\begin{verbatim}
## [1] -1.4302316 -1.4343401 -0.1246347 -0.5260969 -0.4436967 -1.9330892
\end{verbatim}
...
\begin{verbatim}
## [1] -0.5743493 -0.5070755  1.4355577  1.3126615  0.7112333  0.6778853
\end{verbatim}
...
\begin{verbatim}
## [1]  0.7000870 -0.5522761  0.2965319 -0.7902541  1.9462841  0.5261410
\end{verbatim}
