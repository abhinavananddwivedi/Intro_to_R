...
A data frame is a rectangular collection of variables (in the columns) and observations (in the rows). It's different from a 'mere' matrix since the columns have variable names usually and can contain different "types", say numeric and categorical and character and logical all together. 
...
1. plotting multiple variables in one frame
...
temp <- cbind(1991:2010, rnorm(20, 0, 1), rnorm(20, -1, 5)) %>%
  tibble::as_tibble()
names(temp) <- c("year", "N01", "N25")
